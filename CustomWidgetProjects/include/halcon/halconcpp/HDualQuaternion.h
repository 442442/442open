...
explicit HDualQuaternion(HQuaternion QuatReal, HQuaternion QuatDual);
  ...
  HTuple DualQuatTransPoint3d(const HTuple& Px, const HTuple& Py, const HTuple& Pz, HTuple* Ty, HTuple* Tz) const;

  // Transform a 3D point with a unit dual quaternion.
  double DualQuatTransPoint3d(double Px, double Py, double Pz, double* Ty, double* Tz) const;
