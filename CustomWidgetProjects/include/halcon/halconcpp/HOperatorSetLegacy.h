...
LIntExport Herror control_io_channel(const HTuple& IOChannelHandle, const HTuple& Action, const HTuple& Argument, HTuple* Result);
...
LIntExport Herror create_dl_layer_permutation(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Permutation, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerPermutation);

LIntExport Herror dual_quat_trans_point_3d(const HTuple& DualQuaternion, const HTuple& Px, const HTuple& Py, const HTuple& Pz, HTuple* Tx, HTuple* Ty, HTuple* Tz);

LIntExport Herror equ_histo_image_rect(const HObject& Image, HObject* ImageEquHisto, const HTuple& Mode, const HTuple& MaskWidth, const HTuple& MaskHeight, const HTuple& MaxContrast);

LIntExport Herror get_measure_param(const HTuple& MeasureHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror mean_image_shape(const HObject& Image, const HObject& Mask, HObject* ImageMean);

LIntExport Herror tuple_join(const HTuple& Strings, const HTuple& Separators, HTuple* JoinedStrings);
