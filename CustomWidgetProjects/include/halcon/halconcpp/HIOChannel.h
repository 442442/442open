 ...
 *****************************************************************************/
  ...
  static HTuple ControlIoChannel(const HIOChannelArray& IOChannelHandle, const HString& Action, const HTuple& Argument);

  // Perform an action on I/O channels.
  HTuple ControlIoChannel(const HString& Action, const HTuple& Argument) const;

  // Perform an action on I/O channels.
  HTuple ControlIoChannel(const char* Action, const HTuple& Argument) const;

#ifdef _WIN32
  // Perform an action on I/O channels.
  HTuple ControlIoChannel(const wchar_t* Action, const HTuple& Argument) const;
#endif
