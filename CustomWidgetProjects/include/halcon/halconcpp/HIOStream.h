...
HSerializedItem inline HSerializedItem::Deserialize(std::istream& stream)
{
  ...
  // Serialize a HXLDCont instance to a binary output stream
  inline std::ostream& operator << (std::ostream& stream, const HXLDCont& XLD)
  {
    XLD.SerializeXld().Serialize(stream);
    return stream;
  }
  
  // Deserialize binary input stream to a HXLDCont
  inline std::istream& operator >> (std::istream& stream, HXLDCont& XLD)
  {
    XLD.DeserializeXld(HSerializedItem::Deserialize(stream));
    return stream;
  }

  // Serialize a HXLDPoly instance to a binary output stream
  inline std::ostream& operator << (std::ostream& stream, const HXLDPoly& XLD)
  {
    XLD.SerializeXld().Serialize(stream);
    return stream;
  }
  
  // Deserialize binary input stream to a HXLDPoly
  inline std::istream& operator >> (std::istream& stream, HXLDPoly& XLD)
  {
    XLD.DeserializeXld(HSerializedItem::Deserialize(stream));
    return stream;
  }

  // Serialize a HXLDPara instance to a binary output stream
  inline std::ostream& operator << (std::ostream& stream, const HXLDPara& XLD)
  {
    XLD.SerializeXld().Serialize(stream);
    return stream;
  }
  
  // Deserialize binary input stream to a HXLDPara
  inline std::istream& operator >> (std::istream& stream, HXLDPara& XLD)
  {
    XLD.DeserializeXld(HSerializedItem::Deserialize(stream));
    return stream;
  }

  // Serialize a HXLDModPara instance to a binary output stream
  inline std::ostream& operator << (std::ostream& stream, const HXLDModPara& XLD)
  {
    XLD.SerializeXld().Serialize(stream);
    return stream;
  }
  
  // Deserialize binary input stream to a HXLDModPara
  inline std::istream& operator >> (std::istream& stream, HXLDModPara& XLD)
  {
    XLD.DeserializeXld(HSerializedItem::Deserialize(stream));
    return stream;
  }

  // Serialize a HXLDExtPara instance to a binary output stream
  inline std::ostream& operator << (std::ostream& stream, const HXLDExtPara& XLD)
  {
    XLD.SerializeXld().Serialize(stream);
    return stream;
  }
  
  // Deserialize binary input stream to a HXLDExtPara
  inline std::istream& operator >> (std::istream& stream, HXLDExtPara& XLD)
  {
    XLD.DeserializeXld(HSerializedItem::Deserialize(stream));
    return stream;
  }
