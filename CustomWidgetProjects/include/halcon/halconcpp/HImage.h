...
HTuple Height() const;
  ...
  HImage EquHistoImageRect(const HString& Mode, Hlong MaskWidth, Hlong MaskHeight, const HTuple& MaxContrast) const;

  // Histogram linearization within a rectangluar mask.
  HImage EquHistoImageRect(const HString& Mode, Hlong MaskWidth, Hlong MaskHeight, double MaxContrast) const;

  // Histogram linearization within a rectangluar mask.
  HImage EquHistoImageRect(const char* Mode, Hlong MaskWidth, Hlong MaskHeight, double MaxContrast) const;

#ifdef _WIN32
  // Histogram linearization within a rectangluar mask.
  HImage EquHistoImageRect(const wchar_t* Mode, Hlong MaskWidth, Hlong MaskHeight, double MaxContrast) const;
#endif

  // Return the parameters and properties of a measure object.
  static HTuple GetMeasureParam(const HMeasure& MeasureHandle, const HTuple& GenParamName);

  // Return the parameters and properties of a measure object.
  static HTuple GetMeasureParam(const HMeasure& MeasureHandle, const HString& GenParamName);

  // Return the parameters and properties of a measure object.
  static HTuple GetMeasureParam(const HMeasure& MeasureHandle, const char* GenParamName);

#ifdef _WIN32
  // Return the parameters and properties of a measure object.
  static HTuple GetMeasureParam(const HMeasure& MeasureHandle, const wchar_t* GenParamName);
#endif

  // Smooth image using a mean filter with arbitrary mask.
  HImage MeanImageShape(const HRegion& Mask) const;
