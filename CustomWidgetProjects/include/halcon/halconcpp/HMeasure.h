 ...
 *****************************************************************************/
  ...
  HTuple GetMeasureParam(const HTuple& GenParamName) const;

  // Return the parameters and properties of a measure object.
  HTuple GetMeasureParam(const HString& GenParamName) const;

  // Return the parameters and properties of a measure object.
  HTuple GetMeasureParam(const char* GenParamName) const;

#ifdef _WIN32
  // Return the parameters and properties of a measure object.
  HTuple GetMeasureParam(const wchar_t* GenParamName) const;
#endif
