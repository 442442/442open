...
LIntExport Herror T_control_io_channel(const Htuple IOChannelHandle, const Htuple Action, const Htuple Argument, Htuple *Result);
...
LIntExport Herror T_create_dl_layer_permutation(const Htuple DLLayerInput, const Htuple LayerName, const Htuple Permutation, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerPermutation);
LIntExport Herror T_dual_quat_trans_point_3d(const Htuple DualQuaternion, const Htuple Px, const Htuple Py, const Htuple Pz, Htuple *Tx, Htuple *Ty, Htuple *Tz);
LIntExport Herror T_equ_histo_image_rect(const Hobject Image, Hobject *ImageEquHisto, const Htuple Mode, const Htuple MaskWidth, const Htuple MaskHeight, const Htuple MaxContrast);
LIntExport Herror equ_histo_image_rect(const Hobject Image, Hobject *ImageEquHisto, const char *Mode, Hlong MaskWidth, Hlong MaskHeight, double MaxContrast);
LIntExport Herror T_get_measure_param(const Htuple MeasureHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_mean_image_shape(const Hobject Image, const Hobject Mask, Hobject *ImageMean);
LIntExport Herror mean_image_shape(const Hobject Image, const Hobject Mask, Hobject *ImageMean);
LIntExport Herror T_tuple_join(const Htuple Strings, const Htuple Separators, Htuple *JoinedStrings);
LIntExport Herror tuple_join(const char *Strings, const char *Separators, char *JoinedStrings);
