...
#define H_ERR_ROWTB        3040 /* Row value of a coordinate > 2^15-1
                                   (XL: 2^30 - 1) */
#define H_ERR_ROWTS        3041 /* Row value of a coordinate < -2^15+1
                                   (XL: -2^30+1) */
#define H_ERR_COLTB        3042 /* Column value of a coordinate > 2^15-1
                                   (XL: 2^30 - 1) */
#define H_ERR_COLTS        3043 /* Column value of a coordinate < -2^15+1
                                   (XL: -2^30+1) */
...
#define H_ERR_DL_NODE_DUPLICATE_EDGE  7833 /* DL-Node: There can only be one
...
/* DL Global Context Anomaly Detection */
#define H_ERR_DL_GCAD_NETWORK_NOT_AVAILABLE 7870 /* DL: GC Anomaly Detection network not avialable */
...
#define H_ERR_DEEP_OCR_MODEL_UNKNOWN_CHAR  7899 /* Some character is not
                                                   part of the internal alphabet. */
#define H_ERR_DEEP_OCR_MODEL_INVALID_WORD_LENGTH  7900 /* The given word length is invalid. */
#define H_ERR_DEEP_OCR_MODEL_ALPHABET_NOT_UNIQUE  7901 /* The given alphabet is
                                                          not a unique list of
                                                          characters */
...
#define H_ERR_CAL_AMBIGUOUS                8495 /* Ambigious calibration: Please,
